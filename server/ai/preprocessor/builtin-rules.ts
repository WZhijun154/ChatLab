/**
 * Built-in desensitization rules library
 * Grouped by locale, supports universal and region-specific rules
 */
import type { DesensitizeRule } from './types.js'
...
export const BUILTIN_DESENSITIZE_RULES: DesensitizeRule[] = [
  ...
  // ==================== Credentials / Tokens (all locales) ====================
  {
    id: 'api_key_prefix',
...
/**
 * Get default rules for a specific locale (locale-specific + universal rules).
 */
...
/**
 * Merge new locale rules into an existing rule list.
 * Does not duplicate existing IDs, does not modify existing rules' enabled state.
 */
